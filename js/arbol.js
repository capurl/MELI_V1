...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Estaba solo, queriendo escapar,\n
agotado de siempre sobrepensar.\n
Sin saber quién era, quise viajar,\n
perdido en mi mente, me fui a cantar.\n

Te encontré sin siquiera buscar,\n
descubrí la mejor obra sin teatro pisar.\n
Me dejé llevar al terminar de cantar,\n
y en un instante, el deseo empezó a hablar.\n

Una caminata imprevista nos unió,\n
en un museo, nuestro camino empezó.\n
En el primer festejo, el beso llegó,\n
en el siguiente, el amor se consumó.\n

La plaza se vistió de un amor que nació,\n
el bosque presenció el sentimiento que floreció.\n
El cielo se inundó de deseos al anochecer,\n
y mi miedo tú hiciste desaparecer.\n

Mi corazón sano con algo llamado amor\n
La vida recobro el sentido y el color\n
Tus ojos borraron mi viejo dolor\n
Y entendí lo que es amar sin temor\n

Tomar tu mano es lo mejor que existe\n
Ya nada duele cuando tú estás\n
Cuento los días para volver a verte\n
Por que eres tu, no quiero a nadie más\n`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "~Fer";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2025-03-21T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2025-10-21T00:00:00');
...
function playBackgroundMusic() {
  ...
  if (musicaParam) {
    ...
    audio.src = 'musica/arbol.mp3' + musicaParam;
  }
